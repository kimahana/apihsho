...
// GET /YGG/:name  -> serve payload from ygg_api_cache (if present) else default placeholder
router.get('/:name', async (req, res, next) => {
  const name = req.params.name;
  // If this is one of the core endpoints, pass to next so core handlers win
